        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tax = table.Column<decimal>(type: "decimal(12,2)", precision: 12, scale: 2, nullable: false, defaultValue: 0m)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InvoiceMasters_AspNetUsers_CreatedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceDetails_InvoiceMasterId_ProductId",
                table: "InvoiceDetails",
                columns: new[] { "InvoiceMasterId", "ProductId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceMasters_CreatedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceMasters_CustomerName",
                table: "InvoiceMasters",
                column: "CustomerName");
